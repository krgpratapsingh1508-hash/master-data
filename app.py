...
if uploaded_file is not None: 
 ...
 # Current Year and Offset Calculation for EX-Students
 ...
 row_session = row.get('Session', row.get('SESSION', row.get('Year_Of_Admission', ''))).strip()
 ...
 # EX-Students Logic with Dynamic Year Offset
 elif 'EX-STUDENT' in status or 'EX' in status: 
 if ex_target_year_str in row_session: 
