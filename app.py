...
if not filtered_db.empty:
    ...
    # ----------------------------------------------------------------------
    # 📝 3. CCE HANDLER PANEL (PART 1 - SELECTIONS & FILTERING GRID)
    # ----------------------------------------------------------------------
    if role in ["cce_handler", "full_admin"] and not st.session_state.admin_hide_cce:
        ...
        if not live_db.empty:
            ...
            # 3. बैकएंड इवैल्यूएशन ईयर मैपिंग लॉजिक
            mapping_logic = {
            ...
            # 4. डायनेमिक हेडर टाइटल्स का निर्माण
            ...
            if st.session_state.cce_foil_generated:
                ...
                # रिकॉर्ड्स को साफ और सॉर्ट करें (Ex-Students हमेशा सबसे ऊपर पहले आएंगे)
                ...
                final_records_list = ex_student_records + regular_records
                    ...
                    # 1st Year के छात्र का नाम आने पर डायनेमिक कॉलम हेडर लेबल सेट करें
                    ...
                    def generate_cce_html_block(items, start_idx, foil_label, has_data):
                        ...
                        # पेपर कोड के सामने डेटाबेस से खोजा गया 'Subject Code' प्रिंट करें
                    ...
                    # स्क्रीनशॉट कैप्चर स्क्रिप्ट के साथ पूर्ण DOM संकलन
                    full_html = f"""
                    <html>
                    <head>
                        {html_style}
